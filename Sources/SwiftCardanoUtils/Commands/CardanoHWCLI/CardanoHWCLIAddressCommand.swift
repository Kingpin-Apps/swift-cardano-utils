    ...
    public struct AddressCommandImpl: CommandProtocol {
        ...
        public func show(
            ...
            guard hasPaymentPath != hasPaymentScriptHash else {
                throw SwiftCardanoUtilsError.invalidParameters("Either paymentPath OR paymentScriptHash must be specified, but not both")
            }
            ...
            guard hasStakingPath != hasStakingScriptHash else {
                throw SwiftCardanoUtilsError.invalidParameters("Either stakingPath OR stakingScriptHash must be specified, but not both")
            }
