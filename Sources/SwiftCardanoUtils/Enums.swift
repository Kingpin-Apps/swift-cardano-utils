...
/// Mnemonic input options for CardanoSigner
public enum MnemonicInput {
    /// Mnemonic words as a string
    case words(String)
    /// Mnemonic words from a file
    case file(FilePath)
}

/// Derivation methods supported by CardanoSigner
public enum CardanoSignerDerivationMethod {
    /// Ledger hardware wallet derivation
    case ledger
    /// Trezor hardware wallet derivation
    case trezor
    /// Byron (Daedalus) derivation - supports 12/27 word seeds
    case byron
    /// Yoroi Byron derivation - supports 15/21 word seeds
    case yoroi
    /// Exodus Shelley payment derivation
    case exodus
    /// Exodus Shelley stake derivation
    case exodusStake
}

/// CIP signing modes for CardanoSigner
public enum CipSignMode: String {
    /// CIP-8 signing mode
    case cip8 = "--cip8"
    /// CIP-30 signing mode  
    case cip30 = "--cip30"
