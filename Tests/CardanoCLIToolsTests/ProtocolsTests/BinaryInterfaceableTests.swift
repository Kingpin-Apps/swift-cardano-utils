    ...
    struct MockBinaryInterfaceable: BinaryInterfaceable {
        ...
        func runCommand(_ arguments: [String]) async throws -> String {
            if shouldFailCommands {
                throw CardanoCLIToolsError.commandFailed(arguments, "Mock command failure")
            }
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                do {
                    ...
                    continuation.resume(throwing: CardanoCLIToolsError.commandFailed(arguments, "Failed to run command: \(error.localizedDescription)"))
                }
            }
        }
    }
